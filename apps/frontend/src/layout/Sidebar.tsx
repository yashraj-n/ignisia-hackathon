  ...
  return (
    <div className="relative shrink-0 z-20">
      <motion.aside 
        ...
        className="border-r border-white/10 glass-panel h-screen flex flex-col overflow-hidden"
      >
              ...
              return (
                ...
                >
                  ...
                  {isActive && (
                    <>
                      <motion.div
                        ...
                        className="absolute left-0 top-1/4 bottom-1/4 w-[3px] bg-primary shadow-[0_0_10px_rgba(234,179,8,0.8)] rounded-r-md"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                  ...
                  <Icon className={clsx(
                    ...
                    isActive ? "text-primary" : "group-hover:text-white/90"
                  )} />
      ...
      {/* Collapse toggle button - centered vertically on sidebar edge */}
      <button
        onClick={onToggle}
        className={clsx(
          "absolute top-1/2 -translate-y-1/2 z-30 flex items-center justify-center w-7 h-7",
